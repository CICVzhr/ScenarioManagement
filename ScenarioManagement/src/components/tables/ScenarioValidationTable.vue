<template>
  <DataTable :data="tableData" class="full-width-table">
    <el-table-column prop="id" label="案例ID" min-width="100" />
    <el-table-column prop="name" label="场景名称" min-width="200" />
    <el-table-column prop="type" label="场景类型" min-width="120" />
    ...
    <el-table-column label="操作" min-width="260">
      <template #default="scope">
        ...
        <ActionButton text="验证" type="primary" size="small" @click="emit('validate', scope.row)" />
...
const emit = defineEmits(['view', 'validate', 'edit', 'approval'])
</script>
