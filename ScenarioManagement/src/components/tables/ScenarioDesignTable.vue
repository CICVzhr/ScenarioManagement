<template>
  <DataTable :data="tableData" class="full-width-table">
    <el-table-column prop="id" label="场景ID" min-width="100" align="center"/>
    <el-table-column prop="dcid" label="案例ID" min-width="100" align="center"/>
    <el-table-column prop="name" label="场景名称" min-width="200" align="center"/>
    ...
    <el-table-column label="操作" min-width="260" align="center">
      <template #default="scope">
        <ActionButton text="查看" type="primary" size="small" @click="emit('edit', scope.row)" />
...
const emit = defineEmits(['edit', 'approval'])
</script>
